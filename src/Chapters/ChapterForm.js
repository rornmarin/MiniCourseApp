...
export default function ChapterForm({
    ...
    return ( 
      <>
      <h1 className='mb-5 text-2xl font-bold text-left px-10 mt-5'>Chapters</h1>
        <div className="py-5 border-primary700 rounded-xl bg-indigo-100 shadow-lg shadow-slate-100 mx-10 ">
          <div className="space-y-4 w-full"> 
            ...
            <div className='px-5 text-left'>
              ...
              <TextBox
                ...
                onBlurHandler={props.handleBlur}
              />
              <ErrorMessage name={`chapters.${chapterIndex}.summary`} component={'dev'} className='text-red-500'/>

              <div className="flex gap-2 justify-end mt-5 mx-10">
                <button
            ...
            <div className="header flex justify-between">
              <h1 className="text-xl font-bold mx-20">Lession</h1>
            </div>
             <div className='border border-sky-500 mx-20' >
